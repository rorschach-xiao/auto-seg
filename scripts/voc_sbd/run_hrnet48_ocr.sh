...
CUDA_VISIBLE_DEVICES=0,1,2,3 python tools/test.py --cfg experiments/voc_sbd/seg_hrnet_w48_ocr_cls20_520x520_sgd_lr1e-3_wd1e-4_bs_16_epoch80.yaml \
                     DATASET.TEST_SET list/voc_sbd/test2012.txt \
                     TEST.MODEL_FILE output/voc_sbd/seg_hrnet_w48_ocr_cls20_520x520_sgd_lr1e-3_wd1e-4_bs_16_epoch80/best.pth \
